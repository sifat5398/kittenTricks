...
try {
  ...
  env = {
    UI_KITTEN_PACKAGES_PATH:
      process.env.UI_KITTEN_PACKAGES_PATH ||
      path.resolve(__dirname, "node_modules/@ui-kitten"),
    EVA_PACKAGES_PATH:
      process.env.EVA_PACKAGES_PATH ||
...
const extraNodeModules = {
  ...
  // @ui-kitten/eva-icons
  "react-native-eva-icons": path.resolve(
    __dirname,
...
module.exports = {
  ...
  watchFolders: [...defaultConfig.watchFolders, ...appModules],
};
